      ...
      sections: [
        {
          ...
          content: "A. Kişisel Bilgiler\nÇocuklardan veya ebeveynlerden HİÇBİR kişisel tanımlayıcı bilgi (isim, e-posta, telefon, adres vb.) TOPLAMIYORUZ.\n\nB. Kişisel Olmayan Bilgiler\nUygulamanın düzgün çalışması için cihaz modeli, işletim sistemi sürümü ve dil tercihi gibi teknik veriler otomatik olarak işlenebilir. Bu veriler kimliğinizi belirlemek için kullanılmaz."
        },
        {
          title: "3. İzinler ve Özellik Kullanımı",
          content: "A. Kamera\nKullanım: Nesne tanıma ve oyun özellikleri için cihaz kamerasını kullanırız.\nVeri İşleme:\n• Klasik Mod: Görüntüler cihazınızda (çevrimdışı) Google ML Kit ile işlenir.\n• Akıllı Mod (AI): Görüntüler, sadece nesneyi tanımlamak amacıyla anlık olarak Google Gemini (Vertex AI) sunucularına gönderilir ve analiz edilir.\nDepolama: Uygulama içinde çekilen fotoğrafları sunucularımıza veya cihaz galerisine KAYDETMİYORUZ. Analiz bittiği anda görüntü verisi silinir.\n\nB. Mikrofon\nKullanım: Sesli yanıt oyunları için kullanılır.\nVeri İşleme: Ses verisi anlık olarak işlenir ve komuta dönüştürülür. Ses kayıtları asla saklanmaz."
        },
        {
          title: "4. Üçüncü Taraf Hizmetleri",
          content: "Uygulamamızın çalışması için güvenilir servis sağlayıcılar kullanıyoruz. Bu servisler çocuk güvenliği ayarlarıyla yapılandırılmıştır:\n\n• Google Gemini (AI): Görüntü analizi için kullanılır. Veriler Google tarafından model eğitimi için kullanılmaz, sadece işlem anında kullanılır.\n• Google AdMob (Reklamlar): Uygulamada gösterilen reklamlar \"Çocuklara Yönelik\" (Child Directed) olarak işaretlenmiştir. Kişiselleştirilmiş reklamlar (davranışsal hedefleme) kapalıdır. Sadece genel izleyici kitlesine (G) uygun içerikler gösterilir.\n• Google Cloud TTS: Metinleri sese çevirmek için kullanılır."
        },
        {
          title: "5. Ebeveyn Kilidi (Parental Gate)",
          content: "Uygulama dışına çıkan tüm bağlantılar (Gizlilik politikası, Ayarlar, Sosyal Medya) matematiksel bir işlem sorusu ile korunan \"Ebeveyn Kilidi\" arkasındadır. Bu sayede çocukların uygulama dışına çıkması engellenir."
        },
        {
          title: "6. Veri Güvenliği",
          content: "Oyun skorları ve kazanılan ödüller sadece sizin cihazınızda (yerel depolama) tutulur. Uygulamayı silerseniz bu veriler kaybolur. Bulut yedeklemesi yapmıyoruz."
        },
        {
          title: "7. İletişim",
          content: "Gizlilik politikamızla ilgili sorularınız için bize ulaşabilirsiniz:\n\nE-posta: game.kidsai.app@gmail.com"
        }
      ]
    }
};
